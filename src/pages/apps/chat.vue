...
import ChatLog from "@/views/apps/chat/Conversas.vue"
import ChatActiveChatUserProfileSidebarContent from "@/views/apps/chat/DetalhesDoContacto.vue"
import ChatLeftSidebarContent from "@/views/apps/chat/ListaConversasContactos.vue"
import ChatUserProfileSidebarContent from "@/views/apps/chat/Utilizador.vue"
