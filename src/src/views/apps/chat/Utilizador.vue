      ...
      <div class="text-medium-emphasis">
        ...
        <div class="d-flex align-center my-3">
          <VIcon
            ...
            size="22"
          />
          <span class="text-high-emphasis">Verificação de 2 etapas</span>
        </div>
        <div class="d-flex align-center mb-3">
          <VIcon
            ...
            size="22"
          />
          <span class="text-high-emphasis">Notificações</span>
        </div>
        <div class="d-flex align-center mb-3">
          <VIcon
            class="me-2"
            ...
            size="22"
          />
          <span class="text-high-emphasis">Convidar amigos</span>
        </div>
        <div class="d-flex align-center">
          <VIcon
            ...
            size="22"
          />
          <span class="text-high-emphasis">Apagar a conta</span>
        </div>
      </div>
