...
const data = {
  ...
  categories: [
      ...
      subCategories: [
        {
          ...
          articles: [
            ...
            },
            {
              ...
              content: '<p>You can change the email Endereço associated with your personal account at any time from account settings.</p> <p><strong>Note:</strong> You cannot change your primary email Endereço to an email that is already set to be your backup email address.</p><p>You can change the email Endereço associated with your personal account at any time from account settings.</p> <p><strong>Note:</strong> You cannot change your primary email Endereço to an email that is already set to be your backup email address.</p>',
            },
            {
            ...
            },
            {
              ...
              content: '<p>Deleting your personal account removes data associated with your account.</p> <p>When you delete your account we stop billing you. The email Endereço associated with the account becomes available for use with a different account on website. After 90 days, the account name also becomes available to anyone else to use on a new account.</p><p>Deleting your personal account removes data associated with your account.</p> <p>When you delete your account we stop billing you. The email Endereço associated with the account becomes available for use with a different account on website. After 90 days, the account name also becomes available to anyone else to use on a new account.</p>',
            },
          ],
        },
        {
          ...
          articles: [
            ...
            },
            {
              ...
              content: '<p>Two-factor authentication (2FA) is an extra layer of seguranca used when logging into websites or apps. With 2FA, you have to log in with your username and password and provide another form of authentication that only you know or have access to.</p> <p>For our app, the second form of authentication is a code that\'s generated by an application on your mobile Device or sent as a text message (SMS). After you enable 2FA, App generates an authentication code any time someone attempts to sign into your account. The only way someone can sign into your account is if they know both your password and have access to the authentication code on your phone.</p><p>Two-factor authentication (2FA) is an extra layer of seguranca used when logging into websites or apps. With 2FA, you have to log in with your username and password and provide another form of authentication that only you know or have access to.</p> <p>For our app, the second form of authentication is a code that\'s generated by an application on your mobile Device or sent as a text message (SMS). After you enable 2FA, App generates an authentication code any time someone attempts to sign into your account. The only way someone can sign into your account is if they know both your password and have access to the authentication code on your phone.</p>',
            },
            {
              ...
              content: '<p>If you lose access to your two-factor authentication credentials, you can use your recovery codes, or another recovery option, to regain access to your account.</p> <p><strong>Warning:</strong> For seguranca reasons, Our Support may not be able to restore access to accounts with two-factor authentication enabled if you lose your two-factor authentication credentials or lose access to your account recovery methods.</p><p>If you lose access to your two-factor authentication credentials, you can use your recovery codes, or another recovery option, to regain access to your account.</p> <p><strong>Warning:</strong> For seguranca reasons, Our Support may not be able to restore access to accounts with two-factor authentication enabled if you lose your two-factor authentication credentials or lose access to your account recovery methods.</p>',
            },
            {
              slug: 'how-to-review-seguranca-logs',
              title: 'How to review seguranca logs?',
              content: '<p>You can review the seguranca log for your personal account to better understand actions you\'ve performed and actions others have performed that involve you.</p> <p>You can refer your seguranca log from the settings.</p><p>You can review the seguranca log for your personal account to better understand actions you\'ve performed and actions others have performed that involve you.</p> <p>You can refer your seguranca log from the settings.</p>',
            },
          ],
        },
        {
          ...
          articles: [
            ...
            },
            {
              ...
              content: '<p>Your personal account\'s primary email is where we send receipts and other billing-related communication.</p> <p>Your primary email Endereço is the first email listed in your account email settings. We also use your primary email Endereço as our billing email address.</p> <p>If you\'d like to change your billing email you can do it from account settings.</p><p>Your personal account\'s primary email is where we send receipts and other billing-related communication.</p> <p>Your primary email Endereço is the first email listed in your account email settings. We also use your primary email Endereço as our billing email address.</p> <p>If you\'d like to change your billing email you can do it from account settings.</p>',
            },
          ],
        },
      ],
        ...
        },
        {
          ...
          articles: [
            ...
            },
            {
              ...
              content: '<p>You can be charged several third-party transaction fees for online transactions. For credit card transactions, the issuer, the acquirer, and the credit card company all charge a small fee for using their services.</p><p>You aren\'t charged third-party transaction fees for orders processed through our payment system. You pay credit card processing fees, deprivado on your subscription plan. If you\'re using a third-party payment provider with us, then you\'re charged a third-party transaction fee.</p><p>You can be charged several third-party transaction fees for online transactions. For credit card transactions, the issuer, the acquirer, and the credit card company all charge a small fee for using their services.</p><p>You aren\'t charged third-party transaction fees for orders processed through our payment system. You pay credit card processing fees, deprivado on your subscription plan. If you\'re using a third-party payment provider with us, then you\'re charged a third-party transaction fee.</p>',
            },
            {
              slug: 'cant-complete-payment-on-paypal',
              title: 'Can\'t Complete Payment on PayPal?',
              content: '<p>PayPal uses various seguranca measures to protect their users. Because of this, PayPal may occasionally prohibit a buyer from submitting payment to a seller through PayPal.</p><p>If you\'re ultimately unable to submit payment, try working with the seller to determine an alternative payment method. Learn how to contact a seller.</p><p>PayPal uses various seguranca measures to protect their users. Because of this, PayPal may occasionally prohibit a buyer from submitting payment to a seller through PayPal.</p><p>If you\'re ultimately unable to submit payment, try working with the seller to determine an alternative payment method. Learn how to contact a seller.</p>',
            },
            {
    ...
    {
      icon: 'tabler-users',
      slug: 'safety-seguranca',
      avatarColor: 'primary',
      title: 'Safety and seguranca',
      subCategories: [
        {
          slug: 'hacked-accounts',
          icon: 'tabler-shield',
          title: 'seguranca and hacked accounts',
          articles: [
            {
        ...
        },
        {
          ...
          articles: [
            ...
            },
            {
              ...
              content: '<p>Are you trying to create a new account, but you\'re told your email Endereço or Telefone is already in use? This support article outlines how your email Endereço may already be in use and how to resolve the issue.</p><p>Are you trying to create a new account, but you\'re told your email Endereço or Telefone is already in use? This support article outlines how your email Endereço may already be in use and how to resolve the issue.</p>',
            },
          ],
        },
      ],
        ...
        },
        {
          ...
          articles: [
            ...
            },
            {
              ...
              content: '<p>For people who live in the United States or any other provincia outside of the European Union or the European Economic Area, the data controller responsible for personal data, Inc. based in San Francisco, California. For people who live in the European Union or the European Economic Area, the data controller is our International Unlimited Company based in Dublin, Ireland.</p><p>For people who live in the United States or any other provincia outside of the European Union or the European Economic Area, the data controller responsible for personal data, Inc. based in San Francisco, California. For people who live in the European Union or the European Economic Area, the data controller is our International Unlimited Company based in Dublin, Ireland.</p>',
            },
            {
          ...
          articles: [
            {
              ...
              content: '<p>You can send a message to your connections directly from the messaging page or connections page.</p><p>The sent message will be visible in the recipient\'s message list and possibly in their email, deprivado on their app notification settings.</p><p>You can send a message to your connections directly from the messaging page or connections page.</p><p>The sent message will be visible in the recipient\'s message list and possibly in their email, deprivado on their app notification settings.</p>',
            },
            {
              slug: 'how-to-edit-or-delete-a-sent-message-within-a-conversation',
              title: 'How to Editar or delete a sent message within a conversation?',
              content: '<p>You can Editar or delete a text only message you send on app.</p><p><strong>Note:</strong>You can only Editar or delete a message within 60 minutes of sending the message.</p><p>You can Editar or delete a text only message you send on app.</p><p><strong>Note:</strong>You can only Editar or delete a message within 60 minutes of sending the message.</p>',
            },
            {
          ...
          articles: [
            {
              ...
              content: '<p>We have introduced two features that will help both job seekers and hirers fully engage with the power of their platform.</p> <ul><li>The #social hiring feature will notify members when a first- or second-degree connection is hiring for a relevant job. When a network connection posts a relevant job on app or adds a #hiring frame to their profile picture, app will notify the job seeker. From there, job seekers will be able to view open jobs that people in their network are hiring for.</li><li>When a member clicks on the job\'s Detalhes page, they will see the “Meet the Hiring Team” feature. Members will be able to connect and message the entire team listed in this section, including the job poster.</li></ul><p>These features will allow members to find jobs through their connections and stand out to the hiring team. As a result, the hiring team will also be able to reach more potential candidates through their network.</p><p>We have introduced two features that will help both job seekers and hirers fully engage with the power of their platform.</p> <ul><li>The #social hiring feature will notify members when a first- or second-degree connection is hiring for a relevant job. When a network connection posts a relevant job on app or adds a #hiring frame to their profile picture, app will notify the job seeker. From there, job seekers will be able to view open jobs that people in their network are hiring for.</li><li>When a member clicks on the job\'s Detalhes page, they will see the “Meet the Hiring Team” feature. Members will be able to connect and message the entire team listed in this section, including the job poster.</li></ul><p>These features will allow members to find jobs through their connections and stand out to the hiring team. As a result, the hiring team will also be able to reach more potential candidates through their network.</p>',
            },
            {
          ...
          articles: [
            {
              ...
              content: '<p>You can build your network by importing a list of your contacts you already know on the app. This will run a one-time upload of your Endereço book contacts, as well as their detailed contact information. We periodically import and store Detalhes about your Endereço book contacts to suggest relevant contacts for you to connect with, to show you relevant updates, and for other uses explained in our Privacy Policy. We\'ll never email anyone without your permission.</p><p>You can build your network by importing a list of your contacts you already know on the app. This will run a one-time upload of your Endereço book contacts, as well as their detailed contact information. We periodically import and store Detalhes about your Endereço book contacts to suggest relevant contacts for you to connect with, to show you relevant updates, and for other uses explained in our Privacy Policy. We\'ll never email anyone without your permission.</p>',
            },
            {
              slug: 'various-ways-to-connect-with-people',
              title: 'Various ways to connect with people?',
              content: '<p>Building your network is a great way to stay in touch with alumni, colleagues, and recruiters, as well as connect with new, professional opportunities. A primary email Endereço is mandatory to send invitations. Members become 1st-degree connections when they accept your invitation.</p><p>First-degree connections are given access to any information you\'ve displayed on your profile. To ensure an optimal site experience, the members can have a maximum of 30,000 1st-degree connections.</p><p>Building your network is a great way to stay in touch with alumni, colleagues, and recruiters, as well as connect with new, professional opportunities. A primary email Endereço is mandatory to send invitations. Members become 1st-degree connections when they accept your invitation.</p><p>First-degree connections are given access to any information you\'ve displayed on your profile. To ensure an optimal site experience, the members can have a maximum of 30,000 1st-degree connections.</p>',
            },
            {
...
mock.onGet('/pages/ajuda/landing').reply(() => {
  const allArticles = []
...
mock.onGet('/pages/ajuda/subcategory').reply(config => {
...
mock.onGet('/pages/ajuda/article').reply(config => {
