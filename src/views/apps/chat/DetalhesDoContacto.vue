...
<template>
  <template v-if="store.activeChat">
    ...
    >
      <!-- About -->
      <div class="my-8">
        <span class="text-sm text-disabled">SOBRE</span>
        <p class="mt-2">
      ...
      <div class="mb-8">
        <span class="d-block text-sm text-disabled mb-3">INFORMAÇÕES PESSOAIS </span>
      ...
      <!-- Options -->
      <div>
        <span class="d-block text-sm text-disabled mb-3">OPÇÕES</span>
        <div class="d-flex align-center">
          <VIcon
            class="me-2"
            icon="tabler-badge"
