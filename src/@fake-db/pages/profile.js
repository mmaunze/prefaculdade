...
const data = {
  ...
  profile: {
    about: [
      { property: 'Full Name', value: 'Utilizador', icon: 'tabler-user' },
      { property: 'Status', value: 'publico', icon: 'tabler-check' },
      { property: 'Role', value: 'Developer', icon: 'tabler-star' },
      { property: 'provincia', value: 'Maputo', icon: 'tabler-flag' },
  ...
  teams: [
    ...
    },
    {
      ...
      avatarGroup: [
        ...
        { avatar: avatar6, name: 'Utilizador' },
  ...
  projects: [
    ...
    },
    {
      ...
      avatarGroup: [
        ...
        { avatar: avatar5, name: 'Utilizador' },
