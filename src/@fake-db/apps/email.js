...
const data = {
  emails: [
    ...
    {
      id: 49,
      to: [{ email: 'utilizador@mail.com', name: 'me' }],
      from: {
    ...
    },
    {
      ...
      subject: 'Choose seguranca yes relationship recognize consumer democratic international.',
      cc: [],
      bcc: [],
    ...
    },
    {
      ...
      subject: 'Along represent responsibility seguranca he leg.',
      cc: [],
      bcc: [],
    ...
    },
    {
      ...
      replies: [
        ...
        },
        {
          ...
          cc: [],
          bcc: [],
          message: '<p>Stop military interest. Picture his money go quickly. Possible second wide high.\nTime air somebody on development born charge. Marriage Endereço pull. Laugh chair range standard open list consumer wide.</p><p>Dinner another but student upon out. Soldier current management hair management.\nLikely population measure Democrat serious result reflect. Property tax knowledge. Recognize top peace nature pattern.</p><p>Table teach knowledge. Economic section seguranca she. Myself share oil decide necessary when smile difference.\nService open oil car. Be model record stuff position scene also. All professional plan as radio candidate movie.</p>',
          attachments: [],
          isStarred: false,
          labels: ['company'],
...
mock.onGet('/apps/email/emails').reply(config => {
  ...
  const filteredData = data.emails.filter(email => (email.from.name.toLowerCase().includes(queryLowered) || email.subject.toLowerCase().includes(queryLowered))
        && isInFolder(email)
